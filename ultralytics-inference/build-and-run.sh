...
MODEL_PATH="$(pwd)/artifacts/yolov8m.onnx" # Path to your ONNX model
CONFIG_PATH="$(pwd)/artifacts/model-config.json" # Path to your model config JSON. Please choose one from model-configs folder
RUNTIME_LIBRARY_PATH="$(pwd)/artifacts/libRuntimeLibrary.so" # Path to the OAAX runtime library
#####################################################################################
